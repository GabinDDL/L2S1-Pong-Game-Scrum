...
public class TransitionClass {
    ...
    /** 
     *  Calculates the position of the scene's top left corner at the end of the animation. 
     * 
    ...
    private static double endPosition(boolean axis, boolean direction, Scene scene) {
        return axis ? (direction ? -scene.getWidth() : scene.getWidth()) : (direction ? -scene.getHeight() : scene.getHeight());
    }
     ...
     *                      - True : sliding effect bottom to top
     *                      - False : sliding effect top to bottom
     * @param actualContainer The BorderPane containing the first section of elements
     * @param nextContainer Pane containing the next section of elements
     * @param endfonction Anonymous function executed when the animation is finished
     * @throws IOException
     */
    public static void classicGameTransition(boolean axis, boolean direction, Interpolator interpolator, BorderPane actualContainer, Pane nextContainer, EndFunction endFunction) throws IOException {
        ...
        disappearTransition(axis, direction, interpolator, actualContainer, parentContainer, gameScene, true, endFunction);

        // Adds the nextContainer
        appearTransition(axis, direction, interpolator, actualContainer, parentContainer, nextContainer, gameScene, true);
    }
     ...
     *                      - True : sliding effect bottom to top
     *                      - False : sliding effect top to bottom
     * @param path The String path leading to the .fxml of the next section
     * @param actualContainer Current BorderPane containing the first section of elements
     * @throws IOException
     */
    public static void transition(boolean axis, boolean direction, String path, Interpolator interpolator, Parent actualContainer, EndFunction endFunction) throws IOException {
        ...
        // Removes the actualContainer
        disappearTransition(axis, direction, interpolator, actualContainer, parentContainer, scene, true, endFunction);

        // Adds the nextContainer
        appearTransition(axis, direction, interpolator, actualContainer, parentContainer, nextContainer, scene, true);
    }
     ...
     * @param parentContainer The element containing both of actual elements and next elements to display
     * @param scene Scene containing Pane and elements to display
     * @param endfonction Fonction called once the animation is ended
     */
    private static void disappearTransition(boolean axis, boolean direction, Interpolator interpolator, Parent actualContainer, Pane parentContainer, Scene scene, boolean toRemove, EndFunction endFunction) {
        ...
        //      endPos -> the position where top left corner of actualContainer should be at the end of animation
     ...
     * @param scene Scene containing Pane and elements to display
     */
    private static void appearTransition(boolean axis, boolean direction, Interpolator interpolator, Parent actualContainer, Pane parentContainer, Parent nextContainer, Scene scene, boolean toRemove) {
